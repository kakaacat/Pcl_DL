...
def room2blocks(data_label_filename, data, label, num_point, block_size=1.0, stride=1.0,
    ...
    if not os.path.exists("D:/py_Projects/dgcnn.pytorch-master/data/indoor3d_sem_seg_hdf5_data_test/raw_data3d"):
        os.mkdir("D:/py_Projects/dgcnn.pytorch-master/data/indoor3d_sem_seg_hdf5_data_test/raw_data3d")
    if not os.path.exists("D:/py_Projects/dgcnn.pytorch-master/data/indoor3d_sem_seg_hdf5_data_test/raw_data3d/Area_"+str(test_area)):
        os.mkdir("D:/py_Projects/dgcnn.pytorch-master/data/indoor3d_sem_seg_hdf5_data_test/raw_data3d/Area_"+str(test_area))
    # Collect blocks
    block_data_list = []
    block_label_list = []
    global raw_data_index
    for idx in range(len(xbeg_list)): 
       ...
       f = open('D:/py_Projects/dgcnn.pytorch-master/data/indoor3d_sem_seg_hdf5_data_test/raw_data3d/Area_'+str(test_area)+'/'+str(room_name)+'('+str(raw_data_index)+').txt', mode='a')
